...
class ZimMetadataManager(IMetadataManager):
    """Manages metadata for ZIM file downloads."""
    
    def __init__(self, data_dir: str, metadata_filename: str = "downloads_metadata.json"):
        """
    ...
    def load_metadata(self) -> Dict[str, Any]:
        ...
        if not os.path.exists(self.metadata_file):
            self.logger.debug("> ZimMetadataManager::load_metadata Metadata file not found, creating empty metadata")
            return {
                "downloads": [],
                "latest_version": None,
        ...
        try:
            with open(self.metadata_file, 'r') as f:
                ...
                self.logger.debug("> ZimMetadataManager::load_metadata Metadata loaded successfully")
                return metadata
